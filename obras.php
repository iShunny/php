<html>
	...
	<body>
		<div align="center">
			...
			<cor style="font-family: 'Lucida Sans Unicode',Verdana,Arial,sans-serif; font-size: 50px; color: gray;">Obras</cor>
			</fieldset><br>
			<br>
			<br><br>
			<a href="criarobras.php"><input type=submit name="cadastrar" value="criar obra" style="width:100px; height:30px; font-size:17px;"></a>
           ...
           <?php
				...
				$sql = mysql_query("SELECT * FROM `obras` WHERE 1");
				...
				if(isset($_POST['procurar'])) {
					...
					$dados=mysql_query("SELECT * FROM obras WHERE nome LIKE '$nome%' ORDER BY obras;") or die ('Erro ao selecionar os dados');
				...
				if(isset($_POST['page1'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 0;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page2'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 25;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page3'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 50;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page4'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 75;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page5'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 100;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page6'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 125;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page7'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 150;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page8'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 25 OFFSET 175;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page9'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 20 OFFSET 200;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
				...
				if(isset($_POST['page10'])) {
					include("conectar.php");
					$dados=mysql_query('SELECT * FROM obras ORDER BY nome LIMIT 20 OFFSET 225;') or die ('Erro ao selecionar os dados');
					echo "<center><table border=1 cellpadding=0 cellspacing=0 style='background:#E8E8E8; border: simple #000000; border-radius:5px; margin-left:5px; margin-right:5px;'><tr><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Foto</td><td style='padding:5px;'><center><font size=4 color='black' face='verdana'><font size=4 color='black' face='verdana'>Nome</td><td><center><font size=4 color='black' face='verdana'>Usuário</td><td><center><font size=4 color='black' face='verdana'>E-Mail</td><td><center><font size=4 color='black' face='verdana'>Cidade</td><td><center><font size=4 color='black' face='verdana'>Estado</td><td><center><font size=4 color='black' face='verdana'>País</td><td><center><font size=4 color='black' face='verdana'>Nascimento</td></tr>";
						while($resultado=mysql_fetch_assoc($dados)){
							echo "<tr><td width=50 height=50 style='padding:5px;'><img src='imagens/".$resultado['foto'].".png' width=50 height=50></td>";
							echo "<td width=200 style='padding:5px;'>".$resultado['nome']."</td>";
